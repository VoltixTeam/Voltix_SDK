...
void voltix_spic_def_cfg(voltix_spic_cfg_t* cfg) {
  cfg->frequency = VOLTIX_SPIC_FREQUENCY_M8;
  cfg->mode = VOLTIX_SPIC_MODE0_CPOL0_CPHA0;
  cfg->order = VOLTIX_SPIC_ORDER_MSBFIRST;
  cfg->pin_cs = PIN_D7;
  cfg->pin_sck = PIN_D8;
