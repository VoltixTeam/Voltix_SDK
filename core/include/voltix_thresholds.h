#ifndef __VOLTIX_THRESHOLDS_H_
#define __VOLTIX_THRESHOLDS_H_
 ...
 *
 */
void voltix_thresholds_low_set(thr_low_t thr);
 ...
 *
 */
void voltix_thresholds_high_set(thr_high_t thr);
#if defined __cplusplus
}
#endif

#endif /* __VOLTIX_THRESHOLDS_H_ */